...
async function ELF(input, begin = 0, end = input.length) {
  ...
  _ipg_alt: {
    ...
    nt_H_0 = await H(input, begin + left, begin + right);
    ...
    for (let i_i = seq_SH_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await SH(input, begin + left, begin + right);
    ...
    for (let i_i = seq_Sec_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await Sec(input, begin + left, begin + right, (seq_SH_0[i_i - seq_SH_0_start] ?? _ipg_oob()).sh_type);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
...
async function Sec(input, begin = 0, end = input.length, a_sh_type) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_DynSec_0 = await DynSec(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_StrSec_0 = await StrSec(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_DynSymSec_0 = await DynSymSec(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_NoteSec_0 = await NoteSec(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_RelSec_0 = await RelSec(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_RelAddEndSec_0 = await RelAddEndSec(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    self.section = await input.slice(begin + left, begin + right);
    if (left !== right) {
...
async function U64(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function H(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = 4;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    if (!await _ipg_startsWith(input, begin + left, begin + right, "\x7fELF")) break _ipg_alt;
    self._ipg_start = Math.min(self._ipg_start, left);
    right = left + 4;
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.ei_class = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.ei_data = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.ei_version = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.abi = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.abi_version = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_0 = await U64(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_1 = await U64(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_2 = await U64(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U16_4 = await U16(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U16_5 = await U16(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U16_6 = await U16(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U16_7 = await U16(input, begin + left, begin + right);
...
async function SH(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_3 = await U64(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32_2 = await U32(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32_3 = await U32(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32_4 = await U32(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_4 = await U64(input, begin + left, begin + right);
...
async function DynSec(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    for (let i_i = seq_DynSecEntry_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await DynSecEntry(input, begin + left, begin + right);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
...
async function DynSecEntry(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function StrSec(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function Str(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function DynSymSec(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    for (let i_i = seq_DynSymSecEntry_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await DynSymSecEntry(input, begin + left, begin + right);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
...
async function DynSymSecEntry(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.st_info = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.st_other = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
...
async function NoteSec(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function NoteSecEntry(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Name_0 = await Name(input, begin + left, begin + right);
    ...
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Descriptor_0 = await Descriptor(input, begin + left, begin + right);
...
async function Name(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function Descriptor(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function RelAddEndSec(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    for (let i_i = seq_RelAddEndSecEntry_0_start; i_i < loopEnd; i_i++) {
      ...
      const right = 24 * (i_i + 1);
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await RelAddEndSecEntry(input, begin + left, begin + right);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
...
async function RelAddEndSecEntry(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function RelSec(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    for (let i_i = seq_RelSecEntry_0_start; i_i < loopEnd; i_i++) {
      ...
      const right = 16 * (i_i + 1);
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await RelSecEntry(input, begin + left, begin + right);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
...
async function RelSecEntry(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
