...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // H[0, 128]
    left = 0;
    _ipg_failedTerm = { term: "H[0, 128]", left, right };
    right = 128;
    ...
    _ipg_failedTerm = { term: "for i = 0 to H.e_shnum do SH[H.e_shoff + i * H.e_shentsize, H.e_shoff + (i + 1) * H.e_shentsize]" };
    ...
    _ipg_failedTerm = { term: "for i = 1 to H.e_shnum do Sec(SH(i).sh_type)[SH(i).sh_offset, SH(i).sh_offset + SH(i).sh_size]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // DynSec[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "DynSec[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // StrSec[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "StrSec[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // DynSymSec[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "DynSymSec[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // NoteSec[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "NoteSec[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // RelSec[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "RelSec[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // RelAddEndSec[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "RelAddEndSec[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // U16[16, 18]
    left = 16;
    _ipg_failedTerm = { term: "U16[16, 18]", left, right };
    right = 18;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    // U32[U16.END, EOI]
    left = nt_U16._ipg_end;
    _ipg_failedTerm = { term: "U32[U16.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U64[U32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U64[U64.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64 = U64(input, begin + left, begin + right);
    if (nt_U64 === null) break _ipg_alt;
    ...
    // U32[U64.END, EOI]
    left = nt_U64._ipg_end;
    _ipg_failedTerm = { term: "U32[U64.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32 = U32(input, begin + left, begin + right);
    if (nt_U32 === null) break _ipg_alt;
    ...
    // U16[U32.END, EOI]
    left = nt_U32._ipg_end;
    _ipg_failedTerm = { term: "U16[U32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U16 = U16(input, begin + left, begin + right);
    if (nt_U16 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // U32[U32.END, EOI]
    left = nt_U32._ipg_end;
    _ipg_failedTerm = { term: "U32[U32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32 = U32(input, begin + left, begin + right);
    if (nt_U32 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 16 do DynSecEntry[16 * i, 16 * (i + 1)]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // U64[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "U64[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64 = U64(input, begin + left, begin + right);
    if (nt_U64 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "repeat U8[U8.END, EOI].value starting on [0, EOI] until NUL_BYTE" };
    left = 0;
    right = EOI;
    self.values = [];
    while (true) {
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 24 do DynSymSecEntry[24 * i, 24 * (i + 1)]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_U32._ipg_end;
    right = left + 1;
    _ipg_failedTerm = { term: "{ st_info = .[U32.END] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    right = left + 1;
    _ipg_failedTerm = { term: "{ st_other = .[U32.END + 1] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16[U32.END + 2, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U16 = U16(input, begin + left, begin + right);
    if (nt_U16 === null) break _ipg_alt;
    ...
    // U64[U16.END, EOI]
    left = nt_U16._ipg_end;
    _ipg_failedTerm = { term: "U64[U16.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64 = U64(input, begin + left, begin + right);
    if (nt_U64 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_U32._ipg_end;
    _ipg_failedTerm = { term: "Name[U32.END, U32.END + len_name]", left, right };
    ...
    _ipg_failedTerm = { term: "Descriptor[Name.END + (-len_name & 3), Name.END + (-len_name & 3) + len_descriptor]", left, right };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 24 do RelAddEndSecEntry[24 * i, 24 * (i + 1)]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 16 do RelSecEntry[16 * i, 16 * (i + 1)]" };
