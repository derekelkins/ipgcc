...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "SubBlock@2(1)[SubBlock@1.END, innerEnd]", left, right };
    right = self.innerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_ExpectEmpty_0._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty@1[ExpectEmpty@0.END, innerEnd]", left, right };
    right = self.innerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty_1 = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty_1 === null) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "SubBlock@4(1)[SubBlock@3.END, innerEnd]", left, right };
    right = self.innerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "ExpectEmpty@3[ExpectEmpty@2.END, innerEnd]", left, right };
    right = self.innerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
