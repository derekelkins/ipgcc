...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // HeaderV6[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "HeaderV6[0, EOI]", left, right };
    right = EOI;
    ...
    _ipg_failedTerm = { term: "Blocks[HeaderV6.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // MainBlockInfo[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "MainBlockInfo[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "Block(MainBlockInfo.blockType, MainBlockInfo.currentVersion)[MainBlockInfo.END, MainBlockInfo.END + MainBlockInfo.length]", left, right };
    ...
    _ipg_failedTerm = { term: "Bytes[Block.END, MainBlockInfo.END + MainBlockInfo.length]", left, right };
    right = nt_MainBlockInfo._ipg_end + nt_MainBlockInfo.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // U32[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "U32[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U8[U32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "?[ check(U8.value == 0, \"unknown value is non-zero\") ]" };
    if (!check(nt_U8.value == 0, "unknown value is non-zero")) break _ipg_alt;

    // { minVersion = .[U8.END] }
    left = nt_U8._ipg_end;
    right = left + 1;
    _ipg_failedTerm = { term: "{ minVersion = .[U8.END] }", left, right };
    ...
    right = left + 1;
    _ipg_failedTerm = { term: "{ currentVersion = .[U8.END + 1] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    right = left + 1;
    _ipg_failedTerm = { term: "{ blockType = .[U8.END + 2] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "MigrationInfoBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "SceneTreeBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // TreeNodeBlock[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "TreeNodeBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "SceneGlyphItemBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "SceneGroupItemBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "SceneLineItemBlock(version)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "SceneTextItemBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // RootTextBlock[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "RootTextBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "SceneTombstoneItemBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "AuthorIdsBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // PageInfoBlock[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "PageInfoBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // SceneInfo[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "SceneInfo[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // UnknownBlock[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "UnknownBlock[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // VarUInt[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "VarUInt[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "for i = 0 to VarUInt.value do AuthorId[AuthorId.END, EOI]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // SubBlock(0)[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "SubBlock(0)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "VarUInt[SubBlock.END, SubBlock.END + SubBlock.length]", left, right };
    ...
    _ipg_failedTerm = { term: "?[ check(VarUInt.value == 16, \"Expect UUID to have length 16\") ]" };
    ...
    _ipg_failedTerm = { term: "{ uuid = *[VarUInt.END, VarUInt.END + VarUInt.value] }", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16[VarUInt.END + VarUInt.value, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[U16.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // TaggedId(1)[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "TaggedId(1)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "TaggedBool(2)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalTaggedBool(3)[TaggedBool.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "LWWString(2)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "LWWBool(3)[LWWString.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalLWWID(7)[LWWBool.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalLWWU8(8)[OptionalLWWID.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalLWWFloat32(9)[OptionalLWWU8.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalLWWFloat32(10)[OptionalLWWFloat32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // TaggedU32(1)[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "TaggedU32(1)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "TaggedU32(2)[TaggedU32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedU32._ipg_end;
    _ipg_failedTerm = { term: "TaggedU32(3)[TaggedU32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedU32._ipg_end;
    _ipg_failedTerm = { term: "TaggedU32(4)[TaggedU32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedU32._ipg_end;
    _ipg_failedTerm = { term: "OptionalU32(5)[TaggedU32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedId(2)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedBool(3)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedBool._ipg_end;
    _ipg_failedTerm = { term: "SubBlock(4)[TaggedBool.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end;
    _ipg_failedTerm = { term: "TaggedId(1)[SubBlock.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId = TaggedId(input, begin + left, begin + right, 1);
    if (nt_TaggedId === null) break _ipg_alt;
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[TaggedId.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // LWWID(1)[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "LWWID(1)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalLWWBool(2)[LWWID.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalLWWBool(3)[OptionalLWWBool.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_OptionalLWWBool._ipg_end;
    _ipg_failedTerm = { term: "OptionalIntPair(4)[OptionalLWWBool.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedId(3)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedId(4)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedU32(5)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // SceneItemInfo[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "SceneItemInfo[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "SceneGlyphItemBlockValue[SceneItemInfo.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // SubBlock(6)[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "SubBlock(6)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "\"\\x01\"[SubBlock.END, SubBlock.END + 1]", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalU32(2)[SubBlock.END + 1, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "OptionalU32(3)[OptionalU32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_OptionalU32._ipg_end;
    _ipg_failedTerm = { term: "TaggedU32(4)[OptionalU32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32 = TaggedU32(input, begin + left, begin + right, 4);
    if (nt_TaggedU32 === null) break _ipg_alt;
    ...
    left = nt_TaggedU32._ipg_end;
    _ipg_failedTerm = { term: "String(5)[TaggedU32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "SubBlock(6)[String.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock = SubBlock(input, begin + left, begin + right, 6);
    if (nt_SubBlock === null) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end + 1;
    _ipg_failedTerm = { term: "VarUInt[SubBlock.END + 1, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_VarUInt = VarUInt(input, begin + left, begin + right);
    if (nt_VarUInt === null) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "for i = 0 to VarUInt.value do Rectangle[VarUInt.END + 32 * i, SubBlock.END + SubBlock.length]" };
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[Rectangle.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[ExpectEmpty.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // Float64[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "Float64[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "Float64[Float64.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64 = Float64(input, begin + left, begin + right);
    if (nt_Float64 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_SceneItemInfo._ipg_end;
    _ipg_failedTerm = { term: "SceneGroupItemBlockValue[SceneItemInfo.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_SubBlock._ipg_end;
    right = nt_SubBlock._ipg_end + 1;
    _ipg_failedTerm = { term: "\"\\x02\"[SubBlock.END, SubBlock.END + 1]", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end + 1;
    _ipg_failedTerm = { term: "TaggedId(2)[SubBlock.END + 1, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId = TaggedId(input, begin + left, begin + right, 2);
    if (nt_TaggedId === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_SceneItemInfo._ipg_end;
    _ipg_failedTerm = { term: "SceneLineItemBlockValue(version)[SceneItemInfo.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_SubBlock._ipg_end;
    right = nt_SubBlock._ipg_end + 1;
    _ipg_failedTerm = { term: "\"\\x03\"[SubBlock.END, SubBlock.END + 1]", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end + 1;
    _ipg_failedTerm = { term: "TaggedU32(1)[SubBlock.END + 1, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32 = TaggedU32(input, begin + left, begin + right, 1);
    if (nt_TaggedU32 === null) break _ipg_alt;
    ...
    left = nt_TaggedU32._ipg_end;
    _ipg_failedTerm = { term: "TaggedU32(2)[TaggedU32.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32 = TaggedU32(input, begin + left, begin + right, 2);
    if (nt_TaggedU32 === null) break _ipg_alt;
    ...
    left = nt_TaggedU32._ipg_end;
    _ipg_failedTerm = { term: "TaggedFloat64(3)[TaggedU32.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "TaggedFloat32(4)[TaggedFloat64.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "SubBlock(5)[TaggedFloat32.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "?[ check(SubBlock.length % pointSize == 0, \"Point size does not divide subblock size\") ]" };
    ...
    _ipg_failedTerm = { term: "for i = 0 to SubBlock.length / pointSize do Point(version)[SubBlock.END + pointSize * i, SubBlock.END + pointSize * (i + 1)]" };
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[Point.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
    ...
    left = nt_ExpectEmpty._ipg_end;
    _ipg_failedTerm = { term: "TaggedId(6)[ExpectEmpty.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "OptionalTaggedId(7)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[OptionalTaggedId.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // Float32[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "Float32[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "Float32[Float32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float32 = Float32(input, begin + left, begin + right);
    if (nt_Float32 === null) break _ipg_alt;
    ...
    left = nt_Float32._ipg_end;
    _ipg_failedTerm = { term: "PointVersions(version)[Float32.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  ...
  _ipg_alt: {
    ...
    left = nt_U16._ipg_end;
    right = left + 1;
    _ipg_failedTerm = { term: "{ direction = .[U16.END] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    right = left + 1;
    _ipg_failedTerm = { term: "{ pressure = .[U16.END + 1] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "SubBlock(2)[TaggedId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end;
    _ipg_failedTerm = { term: "SubBlock(1)[SubBlock.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end;
    _ipg_failedTerm = { term: "SubBlock(1)[SubBlock.END, innerEnd]", left, right };
    right = self.innerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock = SubBlock(input, begin + left, begin + right, 1);
    if (nt_SubBlock === null) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end;
    _ipg_failedTerm = { term: "VarUInt[SubBlock.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_VarUInt = VarUInt(input, begin + left, begin + right);
    if (nt_VarUInt === null) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "for i = 0 to VarUInt.value do TextItem[TextItem.END, SubBlock.END + SubBlock.length]" };
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[TextItem.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
    ...
    left = nt_ExpectEmpty._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[ExpectEmpty.END, innerEnd]", left, right };
    right = self.innerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
    ...
    left = nt_ExpectEmpty._ipg_end;
    _ipg_failedTerm = { term: "SubBlock(2)[ExpectEmpty.END, outerEnd]", left, right };
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock = SubBlock(input, begin + left, begin + right, 2);
    if (nt_SubBlock === null) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "for i = 0 to VarUInt.value do TextFormat[TextFormat.END, SubBlock.END + SubBlock.length]" };
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[TextFormat.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
    ...
    left = nt_ExpectEmpty._ipg_end;
    _ipg_failedTerm = { term: "SubBlock(3)[ExpectEmpty.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end;
    _ipg_failedTerm = { term: "Float64[SubBlock.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64 = Float64(input, begin + left, begin + right);
    if (nt_Float64 === null) break _ipg_alt;
    ...
    left = nt_Float64._ipg_end;
    _ipg_failedTerm = { term: "Float64[Float64.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64 = Float64(input, begin + left, begin + right);
    if (nt_Float64 === null) break _ipg_alt;
    ...
    left = nt_ExpectEmpty._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[ExpectEmpty.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
    ...
    left = nt_ExpectEmpty._ipg_end;
    _ipg_failedTerm = { term: "TaggedFloat32(4)[ExpectEmpty.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedFloat32 = TaggedFloat32(input, begin + left, begin + right, 4);
    if (nt_TaggedFloat32 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_SubBlock._ipg_end;
    _ipg_failedTerm = { term: "TaggedId(2)[SubBlock.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId = TaggedId(input, begin + left, begin + right, 2);
    if (nt_TaggedId === null) break _ipg_alt;
    ...
    left = nt_TaggedU32._ipg_end;
    _ipg_failedTerm = { term: "TextItemValue[TaggedU32.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[TextItemValue.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "StringWithFormat(6)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "SubBlock(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_VarUInt._ipg_end;
    _ipg_failedTerm = { term: "Bool[VarUInt.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "?[ check(Bool.value, \"StringWithFormat flag unset\") ]" };
    ...
    _ipg_failedTerm = { term: "?[ check(Bool.END + VarUInt.value <= SubBlock.END + SubBlock.length, \"StringWithFormat: Overfull block\") ]" };
    ...
    _ipg_failedTerm = { term: "Bytes[Bool.END, Bool.END + VarUInt.value]", left, right };
    ...
    _ipg_failedTerm = { term: "OptionalU32(2)[Bytes.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalU32 = OptionalU32(input, begin + left, begin + right, 2);
    if (nt_OptionalU32 === null) break _ipg_alt;
    ...
    left = nt_OptionalU32._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[OptionalU32.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // CrdtId[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "CrdtId[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "TaggedId(1)[CrdtId.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId = TaggedId(input, begin + left, begin + right, 1);
    if (nt_TaggedId === null) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end;
    right = nt_SubBlock._ipg_end + 1;
    _ipg_failedTerm = { term: "\"\\x11\"[SubBlock.END, SubBlock.END + 1]", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_SubBlock._ipg_end + 1;
    right = left + 1;
    _ipg_failedTerm = { term: "{ formatCode = .[SubBlock.END + 1] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[SubBlock.END + 2, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "LWWBool(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedBool(2)[TaggedId.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedBool = TaggedBool(input, begin + left, begin + right, 2);
    if (nt_TaggedBool === null) break _ipg_alt;
    ...
    left = nt_TaggedBool._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[TaggedBool.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "LWWU8(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedU8(2)[TaggedId.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "ExpectEmpty[TaggedU8.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "LWWFloat32(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedFloat32(2)[TaggedId.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_TaggedFloat32._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[TaggedFloat32.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "LWWID(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "TaggedId(2)[TaggedId.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId = TaggedId(input, begin + left, begin + right, 2);
    if (nt_TaggedId === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_TaggedId._ipg_end;
    _ipg_failedTerm = { term: "String(2)[TaggedId.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = nt_String._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[String.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "?[ check(Bool.value, \"String flag unset\") ]" };
    ...
    _ipg_failedTerm = { term: "?[ check(Bool.END + VarUInt.value <= SubBlock.END + SubBlock.length, \"String: Overfull block\") ]" };
    ...
    left = nt_Bytes._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[Bytes.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "TaggedU32(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "IntPair(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_SubBlock._ipg_end;
    _ipg_failedTerm = { term: "U32[SubBlock.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32 = U32(input, begin + left, begin + right);
    if (nt_U32 === null) break _ipg_alt;
    ...
    left = nt_U32._ipg_end;
    _ipg_failedTerm = { term: "U32[U32.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32 = U32(input, begin + left, begin + right);
    if (nt_U32 === null) break _ipg_alt;
    ...
    left = nt_U32._ipg_end;
    _ipg_failedTerm = { term: "ExpectEmpty[U32.END, SubBlock.END + SubBlock.length]", left, right };
    right = nt_SubBlock._ipg_end + nt_SubBlock.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty = ExpectEmpty(input, begin + left, begin + right);
    if (nt_ExpectEmpty === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Length4Tag(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U32[Length4Tag.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32 = U32(input, begin + left, begin + right);
    if (nt_U32 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // VarUInt[1, EOI]
    left = 1;
    _ipg_failedTerm = { term: "VarUInt[1, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_VarUInt = VarUInt(input, begin + left, begin + right);
    if (nt_VarUInt === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "TaggedBool(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Byte1Tag(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "Bool[Byte1Tag.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Bool = Bool(input, begin + left, begin + right);
    if (nt_Bool === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_Byte1Tag._ipg_end;
    right = left + 1;
    _ipg_failedTerm = { term: "{ value = .[Byte1Tag.END] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Byte4Tag(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U32[Byte4Tag.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32 = U32(input, begin + left, begin + right);
    if (nt_U32 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_Byte4Tag._ipg_end;
    _ipg_failedTerm = { term: "Float32[Byte4Tag.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float32 = Float32(input, begin + left, begin + right);
    if (nt_Float32 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Byte8Tag(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "Float64[Byte8Tag.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64 = Float64(input, begin + left, begin + right);
    if (nt_Float64 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "TaggedId(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "IDTag(expectedIndex)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "CrdtId[IDTag.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_CrdtId = CrdtId(input, begin + left, begin + right);
    if (nt_CrdtId === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Tag(expectedIndex, 15)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Tag(expectedIndex, 1)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Tag(expectedIndex, 4)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Tag(expectedIndex, 8)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    _ipg_failedTerm = { term: "Tag(expectedIndex, 12)[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "?[ expectedIndex == VarUInt.value >> 4 ]" };
    if (!(a_expectedIndex == nt_VarUInt.value >> 4)) break _ipg_alt;

    // ?[ expectedTagType == (VarUInt.value & 15) ]
    _ipg_failedTerm = { term: "?[ expectedTagType == (VarUInt.value & 15) ]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  ...
  _ipg_alt: {
    ...
    // VarUInt[U8.END, EOI]
    left = nt_U8._ipg_end;
    _ipg_failedTerm = { term: "VarUInt[U8.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_VarUInt = VarUInt(input, begin + left, begin + right);
    if (nt_VarUInt === null) break _ipg_alt;
