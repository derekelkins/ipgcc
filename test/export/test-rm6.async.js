...
export async function RM6(input, begin = 0, end = input.length) {
  ...
  _ipg_alt: {
    ...
    nt_HeaderV6_0 = await HeaderV6(input, begin + left, begin + right);
...
async function HeaderV6(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = 43;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    if (!await _ipg_startsWith(input, begin + left, begin + right, "reMarkable .lines file, version=6          ")) break _ipg_alt;
...
async function FullBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_MainBlockInfo_0 = await MainBlockInfo(input, begin + left, begin + right);
    ...
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Block_0 = await Block(input, begin + left, begin + right, nt_MainBlockInfo_0.blockType, nt_MainBlockInfo_0.currentVersion);
    ...
    right = nt_MainBlockInfo_0._ipg_end + nt_MainBlockInfo_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Bytes_0 = await Bytes(input, begin + left, begin + right);
...
async function MainBlockInfo(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32_0 = await U32(input, begin + left, begin + right);
    ...
    self.minVersion = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.currentVersion = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.blockType = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
...
async function Block(input, begin = 0, end = input.length, a_blockType, a_version) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_MigrationInfoBlock_0 = await MigrationInfoBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneTreeBlock_0 = await SceneTreeBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TreeNodeBlock_0 = await TreeNodeBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneGlyphItemBlock_0 = await SceneGlyphItemBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneGroupItemBlock_0 = await SceneGroupItemBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneLineItemBlock_0 = await SceneLineItemBlock(input, begin + left, begin + right, a_version);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneTextItemBlock_0 = await SceneTextItemBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_RootTextBlock_0 = await RootTextBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneTombstoneItemBlock_0 = await SceneTombstoneItemBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_AuthorIdsBlock_0 = await AuthorIdsBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_PageInfoBlock_0 = await PageInfoBlock(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneInfo_0 = await SceneInfo(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_UnknownBlock_0 = await UnknownBlock(input, begin + left, begin + right);
...
async function AuthorIdsBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_VarUInt_0 = await VarUInt(input, begin + left, begin + right);
    ...
    for (let i_i = seq_AuthorId_0_start; i_i < loopEnd; i_i++) {
      ...
      const right = EOI;
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await AuthorId(input, begin + left, begin + right);
...
async function AuthorId(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_0 = await SubBlock(input, begin + left, begin + right, 0);
    ...
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    self.uuid = await input.slice(begin + left, begin + right);
    if (left !== right) {
      self._ipg_start = Math.min(self._ipg_start, left);
      self._ipg_end = Math.max(self._ipg_end, right);
    }
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty_0 = await ExpectEmpty(input, begin + left, begin + right);
...
async function MigrationInfoBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_0 = await TaggedId(input, begin + left, begin + right, 1);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedBool_0 = await TaggedBool(input, begin + left, begin + right, 2);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalTaggedBool_0 = await OptionalTaggedBool(input, begin + left, begin + right, 3);
...
async function TreeNodeBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_LWWString_0 = await LWWString(input, begin + left, begin + right, 2);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_LWWBool_0 = await LWWBool(input, begin + left, begin + right, 3);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalLWWID_0 = await OptionalLWWID(input, begin + left, begin + right, 7);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalLWWU8_0 = await OptionalLWWU8(input, begin + left, begin + right, 8);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalLWWFloat32_0 = await OptionalLWWFloat32(input, begin + left, begin + right, 9);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalLWWFloat32_1 = await OptionalLWWFloat32(input, begin + left, begin + right, 10);
...
async function PageInfoBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32_0 = await TaggedU32(input, begin + left, begin + right, 1);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32_1 = await TaggedU32(input, begin + left, begin + right, 2);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32_2 = await TaggedU32(input, begin + left, begin + right, 3);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32_3 = await TaggedU32(input, begin + left, begin + right, 4);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalU32_0 = await OptionalU32(input, begin + left, begin + right, 5);
...
async function SceneTreeBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_1 = await TaggedId(input, begin + left, begin + right, 2);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedBool_0 = await TaggedBool(input, begin + left, begin + right, 3);
    if (nt_TaggedBool_0 === null) break _ipg_alt;
    if (nt_TaggedBool_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedBool_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedBool_0._ipg_end);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_0 = await SubBlock(input, begin + left, begin + right, 4);
    if (nt_SubBlock_0 === null) break _ipg_alt;
    if (nt_SubBlock_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_SubBlock_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_SubBlock_0._ipg_end);
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_2 = await TaggedId(input, begin + left, begin + right, 1);
...
async function SceneInfo(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_LWWID_0 = await LWWID(input, begin + left, begin + right, 1);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalLWWBool_0 = await OptionalLWWBool(input, begin + left, begin + right, 2);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalLWWBool_1 = await OptionalLWWBool(input, begin + left, begin + right, 3);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalIntPair_0 = await OptionalIntPair(input, begin + left, begin + right, 4);
...
async function SceneItemInfo(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_2 = await TaggedId(input, begin + left, begin + right, 3);
    if (nt_TaggedId_2 === null) break _ipg_alt;
    if (nt_TaggedId_2._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedId_2._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedId_2._ipg_end);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_3 = await TaggedId(input, begin + left, begin + right, 4);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32_0 = await TaggedU32(input, begin + left, begin + right, 5);
    if (nt_TaggedU32_0 === null) break _ipg_alt;
    if (nt_TaggedU32_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedU32_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedU32_0._ipg_end);
...
async function SceneTombstoneItemBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneItemInfo_0 = await SceneItemInfo(input, begin + left, begin + right);
...
async function SceneGlyphItemBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneGlyphItemBlockValue_0 = await SceneGlyphItemBlockValue(input, begin + left, begin + right);
...
async function SceneGlyphItemBlockValue(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_0 = await SubBlock(input, begin + left, begin + right, 6);
    if (nt_SubBlock_0 === null) break _ipg_alt;
    if (nt_SubBlock_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_SubBlock_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_SubBlock_0._ipg_end);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalU32_0 = await OptionalU32(input, begin + left, begin + right, 2);
    if (nt_OptionalU32_0 === null) break _ipg_alt;
    if (nt_OptionalU32_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_OptionalU32_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_OptionalU32_0._ipg_end);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalU32_1 = await OptionalU32(input, begin + left, begin + right, 3);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32_0 = await TaggedU32(input, begin + left, begin + right, 4);
    if (nt_TaggedU32_0 === null) break _ipg_alt;
    if (nt_TaggedU32_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedU32_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedU32_0._ipg_end);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_String_0 = await String(input, begin + left, begin + right, 5);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_1 = await SubBlock(input, begin + left, begin + right, 6);
    ...
    for (let i_i = seq_Rectangle_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await Rectangle(input, begin + left, begin + right);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty_1 = await ExpectEmpty(input, begin + left, begin + right);
...
async function Rectangle(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64_0 = await Float64(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64_1 = await Float64(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64_2 = await Float64(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float64_3 = await Float64(input, begin + left, begin + right);
...
async function SceneGroupItemBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneGroupItemBlockValue_0 = await SceneGroupItemBlockValue(input, begin + left, begin + right);
...
async function SceneGroupItemBlockValue(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = nt_SubBlock_0._ipg_end + 1;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    if (!await _ipg_startsWith(input, begin + left, begin + right, "\x02")) break _ipg_alt;
    self._ipg_start = Math.min(self._ipg_start, left);
    right = left + 1;
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_0 = await TaggedId(input, begin + left, begin + right, 2);
    if (nt_TaggedId_0 === null) break _ipg_alt;
    if (nt_TaggedId_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedId_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedId_0._ipg_end);
...
async function SceneLineItemBlock(input, begin = 0, end = input.length, a_version) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SceneLineItemBlockValue_0 = await SceneLineItemBlockValue(input, begin + left, begin + right, a_version);
...
async function SceneLineItemBlockValue(input, begin = 0, end = input.length, a_version) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedFloat64_0 = await TaggedFloat64(input, begin + left, begin + right, 3);
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedFloat32_0 = await TaggedFloat32(input, begin + left, begin + right, 4);
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_1 = await SubBlock(input, begin + left, begin + right, 5);
    if (nt_SubBlock_1 === null) break _ipg_alt;
    if (nt_SubBlock_1._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_SubBlock_1._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_SubBlock_1._ipg_end);
    ...
    for (let i_i = seq_Point_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await Point(input, begin + left, begin + right, a_version);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_0 = await TaggedId(input, begin + left, begin + right, 6);
    if (nt_TaggedId_0 === null) break _ipg_alt;
    if (nt_TaggedId_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedId_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedId_0._ipg_end);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_OptionalTaggedId_0 = await OptionalTaggedId(input, begin + left, begin + right, 7);
...
async function Point(input, begin = 0, end = input.length, a_version) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float32_0 = await Float32(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float32_1 = await Float32(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_PointVersions_0 = await PointVersions(input, begin + left, begin + right, a_version);
...
async function PointVersions(input, begin = 0, end = input.length, a_version) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float32_2 = await Float32(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Float32_3 = await Float32(input, begin + left, begin + right);
  ...
  _ipg_alt: {
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.direction = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.pressure = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
...
async function SceneTextItemBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function RootTextBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_0 = await SubBlock(input, begin + left, begin + right, 2);
    if (nt_SubBlock_0 === null) break _ipg_alt;
    if (nt_SubBlock_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_SubBlock_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_SubBlock_0._ipg_end);
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_1 = await SubBlock(input, begin + left, begin + right, 1);
    if (nt_SubBlock_1 === null) break _ipg_alt;
    if (nt_SubBlock_1._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_SubBlock_1._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_SubBlock_1._ipg_end);
    ...
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_2 = await SubBlock(input, begin + left, begin + right, 1);
    ...
    for (let i_i = seq_TextItem_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await TextItem(input, begin + left, begin + right);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_3 = await SubBlock(input, begin + left, begin + right, 2);
    ...
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_4 = await SubBlock(input, begin + left, begin + right, 1);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_VarUInt_1 = await VarUInt(input, begin + left, begin + right);
    ...
    for (let i_i = seq_TextFormat_0_start; i_i < loopEnd; i_i++) {
      ...
      if (left < 0 || right < left || right > EOI) break _ipg_alt;
      const tmp = await TextFormat(input, begin + left, begin + right);
      if (tmp === null) break _ipg_alt;
      if (tmp._ipg_end !== 0) {
        self._ipg_start = Math.min(self._ipg_start, left + tmp._ipg_start);
        self._ipg_end = Math.max(self._ipg_end, left + tmp._ipg_end);
    ...
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty_2 = await ExpectEmpty(input, begin + left, begin + right);
    ...
    right = self.innerEnd2;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty_3 = await ExpectEmpty(input, begin + left, begin + right);
    ...
    right = self.outerEnd;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty_4 = await ExpectEmpty(input, begin + left, begin + right);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_5 = await SubBlock(input, begin + left, begin + right, 3);
    ...
    right = nt_SubBlock_5._ipg_end + nt_SubBlock_5.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_ExpectEmpty_5 = await ExpectEmpty(input, begin + left, begin + right);
...
async function TextItem(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_1 = await TaggedId(input, begin + left, begin + right, 3);
    if (nt_TaggedId_1 === null) break _ipg_alt;
    if (nt_TaggedId_1._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedId_1._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedId_1._ipg_end);
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_2 = await TaggedId(input, begin + left, begin + right, 4);
    if (nt_TaggedId_2 === null) break _ipg_alt;
    if (nt_TaggedId_2._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedId_2._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedId_2._ipg_end);
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TextItemValue_0 = await TextItemValue(input, begin + left, begin + right);
...
async function TextItemValue(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_StringWithFormat_0 = await StringWithFormat(input, begin + left, begin + right, 6);
...
async function StringWithFormat(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_SubBlock_0 = await SubBlock(input, begin + left, begin + right, a_expectedIndex);
    if (nt_SubBlock_0 === null) break _ipg_alt;
    if (nt_SubBlock_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_SubBlock_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_SubBlock_0._ipg_end);
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Bool_0 = await Bool(input, begin + left, begin + right);
...
async function TextFormat(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_CrdtId_0 = await CrdtId(input, begin + left, begin + right);
    ...
    right = nt_SubBlock_0._ipg_end + 1;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    if (!await _ipg_startsWith(input, begin + left, begin + right, "\x11")) break _ipg_alt;
    self._ipg_start = Math.min(self._ipg_start, left);
    right = left + 1;
    self._ipg_end = Math.max(self._ipg_end, right);
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.formatCode = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
...
async function UnknownBlock(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function OptionalLWWBool(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_LWWBool_0 = await LWWBool(input, begin + left, begin + right, a_expectedIndex);
    if (nt_LWWBool_0 === null) break _ipg_alt;
    if (nt_LWWBool_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_LWWBool_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_LWWBool_0._ipg_end);
...
async function LWWBool(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
...
async function OptionalLWWU8(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_LWWU8_0 = await LWWU8(input, begin + left, begin + right, a_expectedIndex);
...
async function LWWU8(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU8_0 = await TaggedU8(input, begin + left, begin + right, 2);
...
async function OptionalLWWFloat32(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_LWWFloat32_0 = await LWWFloat32(input, begin + left, begin + right, a_expectedIndex);
...
async function LWWFloat32(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedFloat32_0 = await TaggedFloat32(input, begin + left, begin + right, 2);
    if (nt_TaggedFloat32_0 === null) break _ipg_alt;
    if (nt_TaggedFloat32_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedFloat32_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedFloat32_0._ipg_end);
...
async function OptionalLWWID(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_LWWID_0 = await LWWID(input, begin + left, begin + right, a_expectedIndex);
    if (nt_LWWID_0 === null) break _ipg_alt;
    if (nt_LWWID_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_LWWID_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_LWWID_0._ipg_end);
...
async function LWWID(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
...
async function LWWString(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_String_0 = await String(input, begin + left, begin + right, 2);
    if (nt_String_0 === null) break _ipg_alt;
    if (nt_String_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_String_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_String_0._ipg_end);
...
async function String(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
...
async function OptionalU32(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedU32_0 = await TaggedU32(input, begin + left, begin + right, a_expectedIndex);
    if (nt_TaggedU32_0 === null) break _ipg_alt;
    if (nt_TaggedU32_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedU32_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedU32_0._ipg_end);
...
async function OptionalIntPair(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_IntPair_0 = await IntPair(input, begin + left, begin + right, a_expectedIndex);
...
async function IntPair(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = nt_SubBlock_0._ipg_end + nt_SubBlock_0.length;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32_1 = await U32(input, begin + left, begin + right);
...
async function SubBlock(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Length4Tag_0 = await Length4Tag(input, begin + left, begin + right, a_expectedIndex);
...
async function CrdtId(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = left + 1;
    if (left < 0 || right > EOI) break _ipg_alt;
    self.part1 = await input.at(begin + left);
    self._ipg_start = Math.min(self._ipg_start, left);
    self._ipg_end = Math.max(self._ipg_end, right);
...
async function OptionalTaggedBool(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedBool_0 = await TaggedBool(input, begin + left, begin + right, a_expectedIndex);
    if (nt_TaggedBool_0 === null) break _ipg_alt;
    if (nt_TaggedBool_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedBool_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedBool_0._ipg_end);
...
async function TaggedBool(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Byte1Tag_0 = await Byte1Tag(input, begin + left, begin + right, a_expectedIndex);
...
async function TaggedU8(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
...
async function TaggedU32(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Byte4Tag_0 = await Byte4Tag(input, begin + left, begin + right, a_expectedIndex);
...
async function TaggedFloat32(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
...
async function TaggedFloat64(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Byte8Tag_0 = await Byte8Tag(input, begin + left, begin + right, a_expectedIndex);
...
async function OptionalTaggedId(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_TaggedId_0 = await TaggedId(input, begin + left, begin + right, a_expectedIndex);
    if (nt_TaggedId_0 === null) break _ipg_alt;
    if (nt_TaggedId_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_TaggedId_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_TaggedId_0._ipg_end);
...
async function TaggedId(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_IDTag_0 = await IDTag(input, begin + left, begin + right, a_expectedIndex);
...
async function IDTag(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Tag_0 = await Tag(input, begin + left, begin + right, a_expectedIndex, 15);
...
async function Byte1Tag(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Tag_0 = await Tag(input, begin + left, begin + right, a_expectedIndex, 1);
    if (nt_Tag_0 === null) break _ipg_alt;
    if (nt_Tag_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_Tag_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_Tag_0._ipg_end);
...
async function Byte4Tag(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Tag_0 = await Tag(input, begin + left, begin + right, a_expectedIndex, 4);
    if (nt_Tag_0 === null) break _ipg_alt;
    if (nt_Tag_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_Tag_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_Tag_0._ipg_end);
...
async function Byte8Tag(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Tag_0 = await Tag(input, begin + left, begin + right, a_expectedIndex, 8);
    if (nt_Tag_0 === null) break _ipg_alt;
    if (nt_Tag_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_Tag_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_Tag_0._ipg_end);
...
async function Length4Tag(input, begin = 0, end = input.length, a_expectedIndex) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_Tag_0 = await Tag(input, begin + left, begin + right, a_expectedIndex, 12);
    if (nt_Tag_0 === null) break _ipg_alt;
    if (nt_Tag_0._ipg_end !== 0) {
      self._ipg_start = Math.min(self._ipg_start, left + nt_Tag_0._ipg_start);
      self._ipg_end = Math.max(self._ipg_end, left + nt_Tag_0._ipg_end);
...
async function Tag(input, begin = 0, end = input.length, a_expectedIndex, a_expectedTagType) {
  const EOI = end - begin; let self;
...
async function ExpectEmpty(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
  ...
  _ipg_alt: {
    ...
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    self._ = await input.slice(begin + left, begin + right);
    if (left !== right) {
      self._ipg_start = Math.min(self._ipg_start, left);
      self._ipg_end = Math.max(self._ipg_end, right);
    }
...
async function Bytes(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function Bool(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function U32(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function Float32(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function Float64(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
...
async function VarUInt(input, begin = 0, end = input.length) {
  const EOI = end - begin; let self;
