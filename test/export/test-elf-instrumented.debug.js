...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // H@0[0, 128]
    left = 0;
    _ipg_failedTerm = { term: "H@0[0, 128]", left, right };
    right = 128;
    ...
    _ipg_failedTerm = { term: "for i = 0 to H@0.e_shnum do SH@0[H@0.e_shoff + i * H@0.e_shentsize, H@0.e_shoff + (i + 1) * H@0.e_shentsize]" };
    ...
    _ipg_failedTerm = { term: "for i = 1 to H@0.e_shnum do Sec@0(SH@0(i).sh_type)[SH@0(i).sh_offset, SH@0(i).sh_offset + SH@0(i).sh_size]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // ?[ sh_type == 6 ]
    _ipg_failedTerm = { term: "?[ sh_type == 6 ]" };
    if (!(a_sh_type == 6)) break _ipg_alt;

    // DynSec@0[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "DynSec@0[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // ?[ sh_type == 3 ]
    _ipg_failedTerm = { term: "?[ sh_type == 3 ]" };
    if (!(a_sh_type == 3)) break _ipg_alt;

    // StrSec@0[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "StrSec@0[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "?[ sh_type == 11 || sh_type == 2 ]" };
    if (!(a_sh_type == 11 || a_sh_type == 2)) break _ipg_alt;

    // DynSymSec@0[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "DynSymSec@0[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // ?[ sh_type == 7 ]
    _ipg_failedTerm = { term: "?[ sh_type == 7 ]" };
    if (!(a_sh_type == 7)) break _ipg_alt;

    // NoteSec@0[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "NoteSec@0[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // ?[ sh_type == 9 ]
    _ipg_failedTerm = { term: "?[ sh_type == 9 ]" };
    if (!(a_sh_type == 9)) break _ipg_alt;

    // RelSec@0[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "RelSec@0[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // ?[ sh_type == 4 ]
    _ipg_failedTerm = { term: "?[ sh_type == 4 ]" };
    if (!(a_sh_type == 4)) break _ipg_alt;

    // RelAddEndSec@0[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "RelAddEndSec@0[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
  ...
  _ipg_alt: {
    ...
    // ?[ sh_type == 8 ]
    _ipg_failedTerm = { term: "?[ sh_type == 8 ]" };
  ...
  _ipg_alt: {
    ...
    left = 0;
    right = EOI;
    _ipg_failedTerm = { term: "{ section = *[0, EOI] }", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    right = 4;
    _ipg_failedTerm = { term: "\"\\x7fELF\"[0, 4]", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = 4;
    right = left + 1;
    _ipg_failedTerm = { term: "{ ei_class = .[4] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    left = 5;
    right = left + 1;
    _ipg_failedTerm = { term: "{ ei_data = .[5] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    left = 6;
    right = left + 1;
    _ipg_failedTerm = { term: "{ ei_version = .[6] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    left = 7;
    right = left + 1;
    _ipg_failedTerm = { term: "{ abi = .[7] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    left = 8;
    right = left + 1;
    _ipg_failedTerm = { term: "{ abi_version = .[8] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    // U16@0[16, 18]
    left = 16;
    _ipg_failedTerm = { term: "U16@0[16, 18]", left, right };
    right = 18;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U32@0[U16@1.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U64@0[U32@0.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U64@1[U64@0.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U64@2[U64@1.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U32@1[U64@2.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16@2[U32@1.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16@4[U16@3.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16@5[U16@4.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16@6[U16@5.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16@7[U16@6.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // U32@1[U32@0.END, EOI]
    left = nt_U32_0._ipg_end;
    _ipg_failedTerm = { term: "U32@1[U32@0.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32_1 = U32(input, begin + left, begin + right);
    if (nt_U32_1 === null) break _ipg_alt;
    ...
    // U64@0[U32@1.END, EOI]
    left = nt_U32_1._ipg_end;
    _ipg_failedTerm = { term: "U64@0[U32@1.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_0 = U64(input, begin + left, begin + right);
    if (nt_U64_0 === null) break _ipg_alt;
    ...
    // U64@3[U64@2.END, EOI]
    left = nt_U64_2._ipg_end;
    _ipg_failedTerm = { term: "U64@3[U64@2.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U32@2[U64@3.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U32@3[U32@2.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U32@4[U32@3.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U64@4[U32@4.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 16 do DynSecEntry@0[16 * i, 16 * (i + 1)]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // U64@0[0, EOI]
    left = 0;
    _ipg_failedTerm = { term: "U64@0[0, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_0 = U64(input, begin + left, begin + right);
    if (nt_U64_0 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "repeat U8@0[U8@0.END, EOI].value starting on [0, EOI] until NUL_BYTE@0" };
    left = 0;
    right = EOI;
    self.values = [];
    while (true) {
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 24 do DynSymSecEntry@0[24 * i, 24 * (i + 1)]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = nt_U32_0._ipg_end;
    right = left + 1;
    _ipg_failedTerm = { term: "{ st_info = .[U32@0.END] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    right = left + 1;
    _ipg_failedTerm = { term: "{ st_other = .[U32@0.END + 1] }", left, right };
    if (left < 0 || right > EOI) break _ipg_alt;
    ...
    _ipg_failedTerm = { term: "U16@0[U32@0.END + 2, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U16_0 = U16(input, begin + left, begin + right);
    if (nt_U16_0 === null) break _ipg_alt;
    ...
    // U64@0[U16@0.END, EOI]
    left = nt_U16_0._ipg_end;
    _ipg_failedTerm = { term: "U64@0[U16@0.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U64_0 = U64(input, begin + left, begin + right);
    if (nt_U64_0 === null) break _ipg_alt;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    // U32@2[U32@1.END, EOI]
    left = nt_U32_1._ipg_end;
    _ipg_failedTerm = { term: "U32@2[U32@1.END, EOI]", left, right };
    right = EOI;
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    nt_U32_2 = U32(input, begin + left, begin + right);
    if (nt_U32_2 === null) break _ipg_alt;
    ...
    left = nt_U32_2._ipg_end;
    _ipg_failedTerm = { term: "Name@0[U32@2.END, U32@2.END + len_name]", left, right };
    ...
    _ipg_failedTerm = { term: "Descriptor@0[Name@0.END + (-len_name & 3), Name@0.END + (-len_name & 3) + len_descriptor]", left, right };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    left = 0;
    right = EOI - 1;
    _ipg_failedTerm = { term: "{ value = *[0, EOI - 1] }", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    ...
    left = EOI - 1;
    right = EOI;
    _ipg_failedTerm = { term: "\"\\x00\"[EOI - 1, EOI]", left, right };
    if (left < 0 || right < left || right > EOI) break _ipg_alt;
    if (!_ipg_startsWith(input, begin + left, begin + right, "\x00")) break _ipg_alt;
    self._ipg_start = Math.min(self._ipg_start, left);
    right = left + 1;
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 24 do RelAddEndSecEntry@0[24 * i, 24 * (i + 1)]" };
...
_ipg_failTreeStack.push(_ipg_currentFailTree);
  _ipg_alt: {
    ...
    _ipg_failedTerm = { term: "for i = 0 to EOI / 16 do RelSecEntry@0[16 * i, 16 * (i + 1)]" };
